 ...
 * @author MMI Agency
 */
public class GooglePageSpeedNodePlugin extends Plugin {
    // The shared instance.
    private static GooglePageSpeedNodePlugin plugin;

    /**
     * The constructor.
     */
    public GooglePageSpeedNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static GooglePageSpeedNodePlugin getDefault() {
        return plugin;
    }
